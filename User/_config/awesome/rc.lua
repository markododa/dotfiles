...
beautiful.init("/home/doda/.config/awesome/themes/zenburn/theme.lua")
...
-- }}}
 ...
 -- {{{ Tags
 tags = {
   names  = { "term", "www", "im", "media", "5", 6, 7, "8", "9"},
   layout = { layouts[4], layouts[11], layouts[1], layouts[10], layouts[11],
